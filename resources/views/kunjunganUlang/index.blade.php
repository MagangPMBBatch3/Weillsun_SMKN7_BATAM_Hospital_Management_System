<x-app-layout>
    <x-slot name="header">
        <div
            ...
            <h2 class="text-2xl font-extrabold tracking-tight text-gray-800 dark:text-gray-100 flex items-center gap-3">
                ...
                <span class=" tracking-wider">Return Visits</span>
            </h2>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mb-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            ...
            {{-- Tabel Data Aktif --}}
            <x-table id="tableActive" :headers="['ID', 'Patient', 'date', 'time', 'description']" requireRole="admin">
                <tbody id="dataKunjunganUlangAktif"></tbody>
            </x-table>

            {{-- Tabel Data Arsip --}}
            <x-table id="tableArchive" class="hidden" :headers="['ID', 'Patient', 'date', 'time', 'description']" requireRole="admin">
            ...
            <x-modal name="edit-kunjunganUlang">
                <div class="p-6">
                    <form onsubmit="event.preventDefault(); updateKunjunganUlang()">
    ...
    {{-- JS --}}
    <script src="{{ asset('js/kunjunganUlang/kunjunganUlang.js') }}"></script>
</x-app-layout>
