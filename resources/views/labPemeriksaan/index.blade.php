<x-app-layout>
    <x-slot name="header">
        <div
            ...
            <h2 class="text-2xl font-extrabold tracking-tight text-gray-800 dark:text-gray-100 flex items-center gap-3">
                ...
                <span class=" tracking-wider">Labs</span>
            </h2>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mb-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            ...
            {{-- Modal CREATE --}}
            <x-modal name="create-labPemeriksaan" focusable>
                <div class="p-6">
                    <form onsubmit="event.preventDefault(); createLabPemeriksaan()">
                        <h2 class="text-xl shadow-md p-4 rounded-md font-bold mb-4">Add New Lab</h2>
                        ...
                        <div class="space-y-3">
                            ...
                            <x-input-label>Inspection</x-input-label>
                            <x-text-input id="create-pemeriksaan" type="text" placeholder="Enter Inspection..."
            ...
            {{-- Modal EDIT --}}
            <x-modal name="edit-labPemeriksaan">
                <div class="p-6">
                    <form onsubmit="event.preventDefault(); updateLabPemeriksaan()">
                        ...
                        <div class="space-y-3">
                            ...
                            <x-input-label>New Inspection</x-input-label>
                            <x-text-input id="edit-pemeriksaan" type="text" placeholder="Enter Inspection..."
                                class="border p-2 w-full rounded" required />
    ...
    {{-- JS --}}
    <script src="{{ asset('js/labPemeriksaan/labPemeriksaan.js') }}"></script>
    <script></script>
