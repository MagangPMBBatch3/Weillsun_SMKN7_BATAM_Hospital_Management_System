<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mb-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            ...
            {{-- Tabel Data Aktif --}}
            <x-table id="tableActive" :headers="['ID', 'Name', 'Date of Birth', 'Gender', 'Address', 'Phone']" :requireRole="['admin','receptionist']">
                <tbody id="dataPasienAktif"></tbody>
            </x-table>

            {{-- Tabel Data Arsip --}}
            <x-table id="tableArchive" class="hidden" :headers="['ID', 'Name', 'Date of Birth', 'Gender', 'Address', 'Phone']" :requireRole="['admin','receptionist']">
