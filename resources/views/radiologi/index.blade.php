<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mb-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            ...
            {{-- Tabel Data Aktif --}}
            <x-table id="tableActive" :headers="['ID', 'patient', 'personnel', 'type', 'result', 'date', 'fee']" requireRole="admin">
                <tbody id="dataRadiologiAktif"></tbody>
            </x-table>

            {{-- Tabel Data Arsip --}}
            <x-table id="tableArchive" class="hidden" :headers="['ID', 'Patient', 'personnel', 'type', 'result', 'date', 'fee']" requireRole="admin">
