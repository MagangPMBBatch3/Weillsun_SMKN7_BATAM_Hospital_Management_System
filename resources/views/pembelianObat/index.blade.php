<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mb-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            ...
            {{-- Tabel Data Aktif --}}
            <x-table id="tableActive" :headers="['ID', 'Supplier', 'date', 'total costs', 'status']" :requireRole="['admin', 'cashier']">
                <tbody id="dataPembelianObatAktif"></tbody>
            </x-table>

            {{-- Tabel Data Arsip --}}
            <x-table id="tableArchive" class="hidden" :headers="['ID', 'Supplier',  'date', 'total costs', 'status']" :requireRole="['admin', 'cashier']">
