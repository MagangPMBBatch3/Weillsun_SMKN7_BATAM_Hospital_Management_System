 <x-app-layout>
     <x-slot name="header">
         <div
             ...
             <h2 class="text-2xl font-extrabold tracking-tight text-gray-800 dark:text-gray-100 flex items-center gap-3">
                 ...
                 <span class=" tracking-wider">Staff Leaves</span>
             </h2>
             ...
             <div class="flex flex-col sm:flex-row sm:items-center gap-3 w-full lg:w-auto">
                 ...
                 <div class="relative w-full sm:w-72">
                     <input type="text" id="search" placeholder="Search..."
                         ...
                         oninput="searchLiburTenagaMedis()">
                     <i class='bx bx-search absolute left-3 top-3 h-5 w-5 text-gray-600 '></i>
                 </div>

                 <!-- Tombol New User -->

                 <x-primary-button x-data="" x-on:click.prevent="$dispatch('open-modal', 'create-libur')"
     ...
     <div class="px-4 sm:px-6 lg:px-8 mb-4">
         <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
             ...
             {{-- Modal CREATE --}}
             <x-modal name="create-libur" focusable>
                 <div class="p-6">
                     <form onsubmit="event.preventDefault(); createLiburTenagaMedis()">
                         ...
                         <div class="space-y-3">
                             ...
                             <x-input-label>Leave Announcement</x-input-label>
                             <textarea id="create-keterangan" required placeholder="Enter Leave Announcement..."
             ...
             {{-- Modal EDIT --}}
             <x-modal name="edit-libur">
                 <div class="p-6">
                     <form onsubmit="event.preventDefault(); updateLiburTenagaMedis()">
                         <h2 class="text-xl shadow-md p-4 rounded-md font-bold mb-4">Edit</h2>
                         ...
                         <div class="space-y-3">
                             ...
                             <select
                                 class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                                 name="edit-doktor" id="edit-doktor">
                                 <option value="" class="text-gray-500 italic">Select Personnel</option>
                                 @foreach ($dokters as $d)
                                     <option value="{{ $d->id }}">
                                         {{ $d->profile->nickname }}
                             ...
                             <x-input-label>Type</x-input-label>
                             <select name="edit-jenis" id="edit-jenis"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                             >
                                 <option value="" disabled class="text-gray-500 italic">Select Type</option>
                                 <option value="libur">Time Off</option>
                             ...
                             <x-input-label>Leave Announcement</x-input-label>
                             <textarea id="edit-keterangan" required placeholder="Enter Leave Announcement..."
                                 class="border p-2 mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"></textarea>
     ...
     {{-- JS --}}
     <script src="{{ asset('js/liburTenagaMedis/liburTenagaMedis.js') }}"></script>
     <script></script>
